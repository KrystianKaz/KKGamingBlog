            ...
            <div class="col-lg-8">
                <div class="blog-post featured-post">
                    <c:if test="${pageNumber == 0}">
                        <c:forEach items="${game}" var="firstGame" begin="0" end="0">
                            <img src="../files/${firstGame.file}" alt="${firstGame.gameTitle}">
                ...
                <div class="row">
                    <c:forEach items="${game}" var="news" begin="${1 + pageNumber * 4}" end="${4 + pageNumber * 4}">
                        <div class="col-md-6">
                            <div class="blog-post">
                                <img src="../files/${news.file}" alt="${news.gameTitle}">
            ...
            <div class="col-lg-4 sidebar">
                <div class="sb-widget">
                    ...
                    <ul class="sb-cata-list">
                        ...
                        <li><a href="/news">News'y<span>${newsSize}</span></a></li>

                    </ul>
                </div>
                <div class="sb-widget">
                    <h2 class="sb-title">Najnowsze news'y</h2>
                    <div class="latest-news-widget">
                        <c:forEach items="${news}" var="newest" begin="0" end="2">
                            <div class="ln-item">
                                <a href="/news/${newest.id}">
                                    <img src="../files/${newest.file}" alt="${newest.newsTitle}">
                                </a>
                                <div class="ln-text">
                                    ...
                                    <div class="ln-metas">
                                        ...
                                        <div class="ln-meta">w <a href="/news">News'y</a></div>

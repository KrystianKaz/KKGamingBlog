            ...
            <div class="col-lg-8">
                <div class="blog-post featured-post">
                    <c:if test="${pageNumber == 0}">
                        <c:forEach items="${news}" var="firstNews" begin="0" end="0">
                            <img src="../files/${firstNews.file}" alt="${firstNews.newsTitle}">
                            ...
                            <div class="post-metas">
                                ...
                                <div class="post-meta">w <a href="/news">News'y</a></div>
                ...
                <div class="row">
                    <c:forEach items="${news}" var="news" begin="${1 + pageNumber * 4}" end="${4 + pageNumber * 4}">
                        <div class="col-md-6">
                            <div class="blog-post">
                                <img src="../files/${news.file}" alt="${news.newsTitle}">
            ...
            <div class="col-lg-4 sidebar">
                <div class="sb-widget">
                    ...
                    <ul class="sb-cata-list">
                        ...
                        <li><a href="/news">News'y<span>${news.size()}</span></a></li>
                    </ul>
                </div>
                <div class="sb-widget">
                        ...
                        <c:forEach items="${games}" var="newestGames" begin="0" end="2">
                            <div class="ln-item">
                                <a href="/games/${newestGames.id}">
                                    <img src="../files/${newestGames.file}"
                ...
                <div class="sb-widget">
                    <h2 class="sb-title">Najnowsze komentarze do news'ów</h2>
                    <div class="latest-comments-widget">
                        <c:forEach items="${commentsList}" var="commentsList" begin="0" end="4">
                            <div class="lc-item">
                                <img src="../files/${service.findUserFileByUsername(commentsList.username)}"

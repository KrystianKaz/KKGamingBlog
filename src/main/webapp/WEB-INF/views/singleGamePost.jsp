                    ...
                    <div class="comments">
                        ...
                        <ul class="comments-list">
                            <c:forEach items="${com}" var="comments">
                                <li>
                                    <img src="../files/${service.findUserFileByUsername(comments.username)}"
                        ...
                        <c:choose>
                            <c:when test="${user != null}">
                                <form method="post" action='<c:url value="/addCommentToTheGamePost"/>'
                                      class="comment-form">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" placeholder="Imię" name="username"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="gameId" value="${gamePost.id}">
                                        </div>
                                    </div>
                                </form>
                            </c:when>

...
import com.site.gamingblog.exception.*;
...
public class UserService {
    ...
    public String emailCheckInDatabase(String email) {
    ...
    public boolean checkIfUserWithGivenNicknameIsInDatabase(String username) {
        ...
        if (byNickname.isPresent()) {
            throw new CreatedUserExistException("User: " + username + " already exists!");
        }
        return false;
    }

    //also used in game.jsp & news.jsp
